...
export
const My_Demo = defs.My_Demo =
class My_Demo extends Component {
  init () {
    ...
    this.background_color = vec4 (0.0, 0.0, 0.0, 1.0);
    ...
    this.materials = {
        plain: new Material("Plain", this.shader, { color: vec4(0.92, 0.22, 0.66, 1.0), diffuse: vec3(0.92, 0.22, 0.66), specular: vec3(1.0, 1.0, 1.0), smoothness: 32.0 }),
